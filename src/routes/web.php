...
Route::group([
    ...
    Route::get('badges', [BadgeController::class, 'index'])->middleware('check.permission:badges');
    ...
    Route::get('badge-types', [BadgeTypeController::class, 'index'])->middleware('check.permission:type-badges');
    ...
    Route::get('contrat-types', [ContratTypeController::class, 'index'])->middleware('check.permission:type-contrats');
    ...
    Route::get('add-salarie',[SalarierController::class,'create'])->middleware('check.permission:add-salarie');
    Route::get('salaries', [SalarierController::class, 'index'])->middleware('check.permission:salaries');
    Route::post('/edit-salarie/{id}', [SalarierController::class, 'update'])->middleware('check.permission:edit-salarie');
    Route::get('edit-salarie/{id}',[SalarierController::class,'edit'])->middleware('check.permission:edit-salarie');
    Route::get('show-salarie/{id}',[SalarierController::class,'show'])->middleware('check.permission:show-salarie');
    ...
    Route::get('/affecte-badge', [SalarierController::class, 'affectation'])->middleware('check.permission:affecte-badge');
    ...
    //Export
    Route::get('/export', [ExportController::class, 'export'])->middleware('check.permission:rapports');
    ...
    Route::get('partenaires', [PartenaireController::class, 'index'])->middleware('check.permission:partenaires');
    ...
    //Visits
    Route::get('/add-visit', [VisitsController::class, 'index']);
    ...
    // Visiteurs
    Route::get('visiteurs', [VisiteurController::class, 'index'])->middleware('check.permission:visits');
    ...
    // Partenaire Visits
    Route::get('partenaire-visits', [PartenaireVisiteController::class, 'index'])->middleware('check.permission:visit-partenaire');
    ...
    //Users
    Route::get('users', [UserController::class, 'index'])->name('users.index')->middleware('check.permission:users');
    ...
    //Roles
    Route::get('roles', [RoleController::class, 'index'])->name('roles.index')->middleware('check.permission:roles');
    ...
    //Permissions
    Route::get('permissions', [PermissionController::class, 'index'])->name('permissions.index')->middleware('check.permission:permissions');
    ...
    Route::get('note-categories', [NoteCategorieController::class, 'index'])->middleware('check.permission:categorie-notes');
    ...
    Route::get('note-sub-categories', [NoteSubCategorieController::class, 'index'])->middleware('check.permission:sous-categorie-notes');
    ...
    Route::get('services', [ServiceController::class, 'index'])->middleware('check.permission:services');
    ...
    //Notes
    Route::get('show-note/{remarques}',[NoteController::class,'show'])->middleware('check.permission:show-note');
    Route::get('notes',[NoteController::class,'index'])->middleware('check.permission:evaluations');
    Route::get('evaluate',[NoteController::class,'evaluate'])->middleware('check.permission:evaluate');
    Route::post('fiche-evaluation',[NoteController::class,'create'])->middleware('check.permission:evaluate');
    ...
    Route::get('edit-note/{id}',[NoteController::class,'edit'])->middleware('check.permission:edit-note');
    ...
    Route::get('documents', [DocumentController::class, 'index'])->middleware('check.permission:type-documents');
    ...
    Route::get('/logs/{id}',[UserController::class,'logs'])->middleware('check.permission:logs-salarie');
    Route::get('/logs',[UserController::class,'allLogs'])->middleware('check.permission:logs');
});
