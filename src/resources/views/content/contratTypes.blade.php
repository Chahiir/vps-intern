...
@section('content')
    ...
    <div class="card">
        ...
        <h5 class="card-header">Liste des types de Contrat</h5>
                        ...
                        <div class="col-xxl">
                            <div class="card mb-4">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0">Ajouter un type Contrat</h5>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="/addContratType">
                                        @csrf
                                        <div class="row mb-3">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <form action="/deleteContratType/{{ $type->id }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            ...
                                            <div class="col-xxl">
                                                <div class="card mb-4">
                                                    <div
                                                        ...
                                                        <h5 class="mb-0">Modifier le type de Contrat</h5>
                                                    </div>
                                                    <div class="card-body">
                                                        <form method="POST" action="editContratType/{{ $type->id }}">
                                                            @csrf
                                                            <div class="row mb-3">
                                                                <label class="col-sm-2 col-form-label"
                                                                    for="basic-default-name">Nom du Contrat</label>
                                                                <div class="col-sm-10">
