...
@section('title', 'Contrat Types ')




@section('content')
    @can('add-type-contrat')
    ...
    <div class="card">
        ...
        <div class="card-header d-flex align-items-center justify-content-between position-relative ">
            <h3 class="mb-8 position-absolute top-100 start-50 translate-middle">Liste des types de contrats</h3>
        </div>
        <br>
        @can('add-type-contrat')
                    ...
                    <div class="modal-body">
                        <div class="col-xxl">
                            <div class="card mb-4">
                                ...
                                <br>
                                <div class="card-body">
                                    <form method="POST" action="/add-contrat-type">
                                        @csrf
                                        <div class="row mb-3">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                      @can('edit-type-contrat')
                                        <a class="dropdown-item" data-bs-toggle="modal"
                                            data-bs-target="#modifier-{{ $type->id }}"><i
                                                class="bx bx-edit-alt me-1"></i> Edit</a>
                                                @endcan
                                                @can('delete-type-contrat')
                                        <form action="/delete-contrat-type/{{ $type->id }}" method="POST" class="delete-form">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <div class="modal-body">
                                            <div class="col-xxl">
                                                <div class="card mb-4">
                                                    ...
                                                    <br>
                                                    <div class="card-body">
                                                        <form method="POST" action="edit-contrat-type/{{ $type->id }}">
                                                            @csrf
                                                            <div class="row mb-3">
                                                                <label class="col-sm-2 col-form-label"
                                                                    for="basic-default-name">Nom du <br> Contrat</label>
                                                                <div class="col-sm-10">
